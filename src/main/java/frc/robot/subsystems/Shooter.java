...
public class Shooter extends SubsystemBase {
	...
	public Spark m_hopperMotor;

	@Log
	public double power;
	public CANEncoder m_shooterEncoder, m_alternateShooterEncoder;
	...
	public Shooter() {
		...
		m_alternateShooterEncoder = m_shooterMotor.getAlternateEncoder();
		m_hopperMotor = new Spark(1);
	}
	...
	public void shoot(double powerId) {
		...
		SmartDashboard.putNumber("Shooter - Encoder Value", m_shooterEncoder.getVelocity());
		SmartDashboard.putNumber("Shooter - AlternateEncoder Value", m_alternateShooterEncoder.getVelocity());
		if (powerId == 1) {
			power = 0.49;
...
//     if (setPoint > 2700 && setPoint < 2800) {
//       m_hopperMotor.set(0.2);
